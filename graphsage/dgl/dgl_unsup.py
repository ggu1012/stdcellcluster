...
def main(args, devices):
    ...
    feat_torch = th.from_numpy(feat_npy).float()
    G_nx = json.load(fG)
    G = json_graph.node_link_graph(G_nx)
    data = dgl.from_networkx(G)
    data.ndata['feat'] = feat_torch
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--fan-out', type=str, default='10,5')
    argparser.add_argument('--batch-size', type=int, default=6795)
    ...
    argparser.add_argument('--result-file', type=str, default='pred')
